...
export default async function HomePage() {
  ...
  return (
    <>
      <div className="mx-auto px-5 md:px-8 pt-14 md:pt-24" style={{ maxWidth: 960 }}>
      ...
      {/* Our Ethos */}
      <div className="mx-auto px-5 md:px-8 pb-14 md:pb-24" style={{ maxWidth: 960 }}>
        <section style={{ paddingTop: 40, textAlign: 'center' }}>
          <div style={{ maxWidth: 640, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            {[t('mission1'), t('mission2')].map((para, i) => (
              <p key={i} style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(16px, 1.8vw, 20px)', lineHeight: 1.9, color: '#1a1a1a', fontWeight: locale === 'zh' ? 400 : 600, textIndent: '2em', marginBottom: i === 0 ? 24 : 0 }}>
                {para}
              </p>
            ))}
